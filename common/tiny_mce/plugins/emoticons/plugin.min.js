! function() {
    ...
    h("3", tinymce.util.Tools.resolve), g("1", ["3"], function(a) {
        ...
        return a.add("emoticons", function(a, c) {
                ...
                var e = [
                    ["cool", "crying", "sweating", "muted"],
                    ["shrug", "angry", "greed", "happy"],
                    ["in-love", "sad", "shocked", "sick"],
                    ["tongue", "whistle", "wink", "laughing"]
                ];
                a.addButton("emoticons", {
                    ...
                    panel: {
                        ...
                        onclick: function(b) {
                            ...
                            c && (a.insertContent(':' + c.getAttribute('data-mce-alt') + ':'), this.hide())
                        }
                    },
                    tooltip: "Emoticons"
                })
